...
Denvar.prototype._readEnvFile = function(env) {
  ...
  // Read .env or env.json file, (automatically) parse in JSON format
  try {
    var fileObject = this.isJSON ? require('./' + this.path) : JSON.parse(fs.readFileSync(this.path, {encoding: encoding}));
